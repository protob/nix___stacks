...
in
{
  containers.wp = {
   ...
   curl -L  https://raw.githubusercontent.com/protob/nix___stacks/main/stacks/blogging/wp-woo/extras/custom-inc.php -o custom-inc.php

   cd /var/www/wpdemo/
   curl -L  https://github.com/protob/nix___stacks/blob/main/stacks/blogging/wp-woo/extras/wp-db.sql -o wp-db.sql
      # curl -L  https://github.com/protob/nix___stacks/blob/main/stacks/blogging/wp-woo/extras/wp-db45.sql -o wp-db45.sql
   curl -L  https://raw.githubusercontent.com/protob/nix___stacks/main/stacks/blogging/wp-woo/extras/wp-db2.sql -o wp-db2.sql
...
cp nix___stacks-main/stacks/blogging/wp-woo/extras/loop2.sh .
cp nix___stacks-main/stacks/blogging/wp-woo/extras/wp-db45.sql .
cp nix___stacks-main/stacks/blogging/wp-woo/extras/cmd.sh .
cp -rn nix___stacks-main/stacks/blogging/wp-woo/extras/chunks ./chunks


        "${pkgs.wp-cli}/bin/wp" db import  wp-db2.sql  --allow-root 
